...
public class Bookrecipepage9Screen extends AbstractContainerScreen<Bookrecipepage9Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("changed_addon:textures/screens/bookrecipepage_9.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, ResourceLocation.parse("changed_addon:textures/screens/syringewithlitixcamonia_slot.png"));
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookrecipepage_9.label_unifuser"), 45, 35, -16777216);
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookrecipepage_9.label_pany_potion"), 7, 9, -256);
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookrecipepage_9.label_p"), 90, 83, -256);
	}
	...
	public void init() {
		...
		button_back = new Button(this.leftPos + 164, this.topPos + -21, 46, 20, Component.translatable("gui.changed_addon.bookrecipepage_9.button_back"), e -> {
			if (true) {
		...
		button_close = new Button(this.leftPos + 215, this.topPos + -21, 51, 20, Component.translatable("gui.changed_addon.bookrecipepage_9.button_close"), e -> {
			if (true) {
