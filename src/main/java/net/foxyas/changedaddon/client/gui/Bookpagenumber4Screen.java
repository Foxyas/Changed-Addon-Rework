...
public class Bookpagenumber4Screen extends AbstractContainerScreen<Bookpagenumber4Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("changed_addon:textures/screens/bookpagenumber_4.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookpagenumber_4.label_n_any_latex_or_blood_syringe"), 17, 12, -16777216);
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookpagenumber_4.label_n"), 62, 78, -16729089);
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookpagenumber_4.label_catalyzer"), 46, 41, -16777216);
	}
	...
	public void init() {
		...
		button_close = new Button(this.leftPos + 215, this.topPos + -21, 51, 20, Component.translatable("gui.changed_addon.bookpagenumber_4.button_close"), e -> {
			if (true) {
		...
		button_back = new Button(this.leftPos + 165, this.topPos + -21, 46, 20, Component.translatable("gui.changed_addon.bookpagenumber_4.button_back"), e -> {
			if (true) {
		...
		imagebutton_recipe_buttom_normal = new ImageButton(this.leftPos + 123, this.topPos + 95, 20, 18, 0, 0, 18, ResourceLocation.parse("changed_addon:textures/screens/atlas/imagebutton_recipe_buttom_normal.png"), 20, 36, e -> {
		});
