...
public class TranfurSoundsGuiScreen extends AbstractContainerScreen<TranfurSoundsGuiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.label_transfursounds"), 49, -24, -1);
	...
	public void init() {
		...
		button_1 = new Button(this.leftPos + 4, this.topPos + 6, 30, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_1"), e -> {
		...
		button_2 = new Button(this.leftPos + 4, this.topPos + 28, 30, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_2"), e -> {
			if (IfCatlatexProcedure.execute(entity)) {
		...
		button_3 = new Button(this.leftPos + 138, this.topPos + 7, 30, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_3"), e -> {
		...
		button_4 = new Button(this.leftPos + 138, this.topPos + 29, 30, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_4"), e -> {
			if (IfDogLatexProcedure.execute(entity)) {
		...
		button_5 = new Button(this.leftPos + 138, this.topPos + 51, 30, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_5"), e -> {
			if (IfDogLatexProcedure.execute(entity)) {
		...
		button_6 = new Button(this.leftPos + 4, this.topPos + 50, 30, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_6"), e -> {
			if (IfCatlatexProcedure.execute(entity)) {
		...
		button_7 = new Button(this.leftPos + 4, this.topPos + 72, 40, 20, new TranslatableComponent("gui.changed_addon.tranfur_sounds_gui.button_7"), e -> {
			if (IfCatlatexProcedure.execute(entity)) {
