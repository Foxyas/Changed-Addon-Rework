...
public class Bookpagenumber5Screen extends AbstractContainerScreen<Bookpagenumber5Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("changed_addon:textures/screens/bookpagenumber_5.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, ResourceLocation.parse("changed_addon:textures/screens/ammonia_compressed_icon.png"));
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.changed_addon.bookpagenumber_5.label_catalyzer"), 44, 43, -16777216);
	}
	...
	public void init() {
		...
		button_back = new Button(this.leftPos + 164, this.topPos + -21, 46, 20, Component.translatable("gui.changed_addon.bookpagenumber_5.button_back"), e -> {
			if (true) {
		...
		button_close = new Button(this.leftPos + 215, this.topPos + -21, 51, 20, Component.translatable("gui.changed_addon.bookpagenumber_5.button_close"), e -> {
			if (true) {
