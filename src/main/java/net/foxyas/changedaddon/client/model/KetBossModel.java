...
public class KetBossModel extends AdvancedHumanoidModel<KetExperiment009BossEntity> implements AdvancedHumanoidModelInterface<KetExperiment009BossEntity,KetBossModel> {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(16, 68).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.15F)).mirror(false), PartPose.offset(5.0F, 1.5F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<KetExperiment009BossEntity, KetBossModel> getAnimator() {
        return animator;
    }
}