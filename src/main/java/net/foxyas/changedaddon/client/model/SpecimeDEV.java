...
public class SpecimeDEV extends AdvancedHumanoidModel<SnowLeopardMaleOrganicEntity> implements AdvancedHumanoidModelInterface<SnowLeopardMaleOrganicEntity,SpecimeDEV> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    // TODO: 16/12/2024 Change And create new Entity for this model [Boss]
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("changed_addon", "temp_dev_name"), "main");
    ...
    private final HumanoidAnimator<SnowLeopardMaleOrganicEntity, SpecimeDEV> animator;

    public SpecimeDEV(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<SnowLeopardMaleOrganicEntity, SpecimeDEV> getAnimator() {
        return animator;
    }
}
	...
	private static class thisCustomLayer<M extends AdvancedHumanoidModel<T>, T extends ChangedEntity> extends EmissiveBodyLayer<M,T> implements FirstPersonLayer<T>{

		public thisCustomLayer(RenderLayerParent<T, M> p_116964_, ResourceLocation emissiveTexture) {
