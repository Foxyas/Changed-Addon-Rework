...
public class ModelColarModel<T extends Entity> extends EntityModel<T> {
	...
	public final ModelPart ColaPart;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Colar = partdefinition.addOrReplaceChild("Colar", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition ColaPart = Colar.addOrReplaceChild("ColaPart", CubeListBuilder.create().texOffs(1, 2).addBox(-4.5F, -24.7F, -3.0F, 9.0F, 2.0F, 6.0F, new CubeDeformation(-0.05F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Necklaces = Colar.addOrReplaceChild("Necklaces", CubeListBuilder.create(), PartPose.offset(0.0F, -24.5F, 0.0F));
