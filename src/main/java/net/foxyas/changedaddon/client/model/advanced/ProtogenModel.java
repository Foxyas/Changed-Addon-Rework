...
public class ProtogenModel extends AdvancedHumanoidModel<ProtogenEntity> implements AdvancedHumanoidModelInterface<ProtogenEntity, ProtogenModel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r4 = LeftEar.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(72, 31).addBox(0.0003F, -0.3869F, 3.4012F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.0845F, 3.6265F, 0.2005F, 0.1745F, -0.384F, 0.0F));

        PartDefinition cube_r5 = LeftEar.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(50, 10).addBox(0.7562F, 0.663F, -0.7984F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9595F, 3.3765F, 0.5255F, -0.1734F, -0.4177F, 0.33F));

        PartDefinition cube_r6 = LeftEar.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 71).addBox(-0.2097F, -0.1769F, -0.7984F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9595F, 3.3765F, 0.5255F, 0.1745F, -0.384F, 0.0F));
        ...
        PartDefinition screen_r1 = middle.addOrReplaceChild("screen_r1", CubeListBuilder.create().texOffs(36, 40).addBox(-2.0F, -2.5F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.05F))
        ...
        PartDefinition screen_r2 = right.addOrReplaceChild("screen_r2", CubeListBuilder.create().texOffs(50, 63).addBox(-0.5F, -2.5F, -3.0F, 1.0F, 5.0F, 6.0F, new CubeDeformation(0.05F))
        ...
        PartDefinition screen_r3 = left.addOrReplaceChild("screen_r3", CubeListBuilder.create().texOffs(70, 0).addBox(-0.5F, -2.5F, -3.0F, 1.0F, 5.0F, 6.0F, new CubeDeformation(0.05F))
