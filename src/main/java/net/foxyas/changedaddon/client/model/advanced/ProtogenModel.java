...
public class ProtogenModel extends AdvancedHumanoidModel<ProtogenEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1067F, -0.5857F, -0.7811F, 0.0436F, 0.0F, 0.0F));

        PartDefinition head_r1 = Head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(25, 2).addBox(-3.0F, -7.0F, -1.5F, 6.0F, 6.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-0.1F, 0.7357F, 1.629F, -0.0436F, 0.0F, 0.0F));

        PartDefinition visor = Head.addOrReplaceChild("visor", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.125F, -2.3728F, 1.1183F, -0.0873F, 0.0F, 0.0F));

        PartDefinition metal = visor.addOrReplaceChild("metal", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition Face_r1 = middle.addOrReplaceChild("Face_r1", CubeListBuilder.create().texOffs(74, 0).addBox(-2.0F, -3.3695F, -2.0085F, 5.0F, 6.0F, 6.0F, new CubeDeformation(0.05F))
                .texOffs(74, 84).addBox(-2.0F, -3.3695F, -2.0085F, 5.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.912F, 1.7606F, 0.1745F, 0.0F, 0.0F));

        PartDefinition right = visor.addOrReplaceChild("right", CubeListBuilder.create(), PartPose.offset(-6.6371F, 0.3153F, -3.8681F));

        PartDefinition Face_r2 = right.addOrReplaceChild("Face_r2", CubeListBuilder.create().texOffs(20, 36).addBox(-0.4136F, -3.3695F, -2.0123F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.05F))
                .texOffs(80, 72).addBox(-0.4136F, -3.3695F, -2.0123F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.3939F, -0.1811F, 0.0757F, 0.1752F, -0.0859F, -0.0152F));

        PartDefinition left = visor.addOrReplaceChild("left", CubeListBuilder.create(), PartPose.offset(5.6737F, 0.3153F, -3.8681F));

        PartDefinition Face_r3 = left.addOrReplaceChild("Face_r3", CubeListBuilder.create().texOffs(32, 70).addBox(0.4098F, -3.3695F, -1.9252F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.05F))
                .texOffs(60, 84).addBox(0.4098F, -3.3695F, -1.9252F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.3939F, -0.1811F, 0.0757F, 0.1752F, 0.0859F, 0.0152F));

        PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create(), PartPose.offsetAndRotation(0.3636F, -7.9883F, -0.9006F, 0.3491F, 0.0F, 0.0F));

        PartDefinition cube_r1 = LeftEar.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(72, 38).addBox(0.1436F, -1.2203F, 3.9081F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.0845F, 3.6117F, 0.1785F, 0.1745F, -0.384F, 0.0F));

        PartDefinition cube_r2 = LeftEar.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(51, 12).mirror().addBox(0.7562F, 0.6778F, -0.8014F, 1.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.9595F, 3.3617F, 0.5285F, -0.1734F, -0.4177F, 0.33F));

        PartDefinition cube_r3 = LeftEar.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(44, 34).mirror().addBox(-0.0663F, -1.0103F, -0.2915F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.9595F, 3.3617F, 0.5285F, 0.1745F, -0.384F, 0.0F));

        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.577F, -7.9883F, -0.9006F, 0.3491F, 0.0F, 0.0F));

        PartDefinition cube_r4 = RightEar.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(72, 32).addBox(-2.1436F, -1.2203F, 3.9081F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(3.0845F, 3.6117F, 0.1785F, 0.1745F, 0.384F, 0.0F));

        PartDefinition cube_r5 = RightEar.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(47, 2).addBox(-1.7562F, 0.6778F, -0.8014F, 1.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9595F, 3.3617F, 0.5285F, -0.1734F, 0.4177F, -0.33F));

        PartDefinition cube_r6 = RightEar.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 72).addBox(-1.9337F, -1.0103F, -0.2915F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9595F, 3.3617F, 0.5285F, 0.1745F, 0.384F, 0.0F));
        ...
        PartDefinition fluff_r1 = Torso.addOrReplaceChild("fluff_r1", CubeListBuilder.create().texOffs(72, 21).addBox(-2.6067F, -1.5F, -3.5F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3933F, 1.7934F, 0.6411F, -0.0873F, 0.0F, 0.0F));

        PartDefinition fluff_r2 = Torso.addOrReplaceChild("fluff_r2", CubeListBuilder.create().texOffs(1, 16).addBox(-3.6067F, -1.5F, -3.5F, 8.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3933F, 0.7934F, 0.6411F, 0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r7 = RightArm.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 79).addBox(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.4F, 0.25F, 0.0F, 0.7854F, 0.0F, 0.0F));
        ...
        PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offset(-2.1F, 10.5F, 0.0F));
        ...
        PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offset(2.1F, 10.5F, 0.0F));
