...
public class ModelFemaleSnowFox extends LatexHumanoidModel<LatexSnowFoxFemaleEntity> implements LatexHumanoidModelInterface<LatexSnowFoxFemaleEntity,ModelFemaleSnowFox> {
    ...
    public static LayerDefinition createBodyLayer() {
       ...
       PartDefinition Tail = Torso.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offset(0.0F, 11.0F, 0.0F));
		...
		PartDefinition RightPawBeans = RightArm.addOrReplaceChild("RightPawBeans", CubeListBuilder.create().texOffs(0, 72).addBox(-1.0F, -0.5F, 0.375F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.075F))
				.texOffs(0, 75).addBox(-0.5F, -0.5F, -1.125F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.075F))
				.texOffs(0, 77).addBox(-1.775F, -0.5F, -0.875F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.075F))
				.texOffs(0, 79).addBox(0.8F, -0.5F, -0.875F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)), PartPose.offset(-1.0F, 9.475F, -0.75F));
		...
		PartDefinition LeftPawBeans = LeftArm.addOrReplaceChild("LeftPawBeans", CubeListBuilder.create().texOffs(9, 72).mirror().addBox(-1.0F, -0.5F, 0.375F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.075F)).mirror(false)
				.texOffs(9, 75).mirror().addBox(-0.5F, -0.5F, -1.125F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false)
				.texOffs(9, 77).mirror().addBox(0.775F, -0.5F, -0.875F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false)
				.texOffs(9, 79).mirror().addBox(-1.8F, -0.5F, -0.875F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.075F)).mirror(false), PartPose.offset(1.0F, 9.475F, -0.75F));
