...
public class CheckPlayerTransfurForm {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        if (event.phase == TickEvent.Phase.END) {
            ...
            ProcessTransfur.ifPlayerTransfurred(player, variant -> player.getCapability(ChangedAddonModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> capability.LatexForm = variant.getFormId().toString())
