...
public class Experiment009SpawneggRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Direction direction, Entity entity, ItemStack itemstack) {
		...
		if (direction == Direction.UP) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new Experiment009Entity(ChangedAddonModEntities.EXPERIMENT_009.get(), _level);
