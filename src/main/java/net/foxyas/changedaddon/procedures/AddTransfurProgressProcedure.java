...
public class AddTransfurProgressProcedure {
    ...
    public static void set(Entity entity, float Amount) {
        ...
        if (entity instanceof Player _entity) {
            ProcessTransfur.setPlayerTransfurProgress(_entity, Amount);
        }
    ...
    public static void setAdd(Entity entity, float Amount) {
        ...
        if (entity instanceof Player _entity) {
            ...
            ProcessTransfur.setPlayerTransfurProgress(_entity, transfurProgress);
        }
    ...
    public static void set(Entity entity, double Amount) {
        ...
        if (entity instanceof Player _entity) {
            ProcessTransfur.setPlayerTransfurProgress(_entity, (float) Amount);
        }
    ...
    public static void SnepsiTransfur(Entity player, int type) {
        if (type == 1) {
            ProcessTransfur.progressTransfur((LivingEntity) player, 15, ChangedAddonTransfurVariants.SNOW_LEOPARD_PARTIAL.get(), TransfurContext.hazard(TransfurCause.GRAB_REPLICATE));
        } else if (type == 2) {
            ProcessTransfur.progressTransfur((LivingEntity) player, 15, ChangedAddonTransfurVariants.Gendered.EXP2.getMaleVariant(), TransfurContext.hazard(TransfurCause.GRAB_REPLICATE));
        } else if (type == 3) {
            ProcessTransfur.progressTransfur((LivingEntity) player, 15, ChangedAddonTransfurVariants.Gendered.EXP2.getFemaleVariant(), TransfurContext.hazard(TransfurCause.GRAB_REPLICATE));
        } else if (type == 4) {
