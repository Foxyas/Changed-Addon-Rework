	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if (itemstack.getItem() == ChangedAddonModItems.SIGNAL_CATCHER.get()) {
			...
			if (!Screen.hasShiftDown()) {
				...
				tooltip.add(new TextComponent("Hold \u00A7b<Right Click>\u00A7r For scam a 32 blocks area"));
				tooltip.add(new TextComponent("Hold \u00A7c<Shift + Right Click>\u00A7r For Super scam and scam a 64 blocks area"));
			}
