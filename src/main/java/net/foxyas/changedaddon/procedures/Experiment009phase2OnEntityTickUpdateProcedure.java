	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((new Object() {
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) <= (entity instanceof LivingEntity _livEnt ? _livEnt.getMaxHealth() : -1) * 0.666) {
				entity.getPersistentData().putDouble("IA", (entity.getPersistentData().getDouble("IA") + 1.5 + 0.1 * ((world.getLevelData().getGameRules().getInt(ChangedAddonModGameRules.CHANGED_ADDON_HARD_MODE_BOSSES)) / 100)));
			} else {
