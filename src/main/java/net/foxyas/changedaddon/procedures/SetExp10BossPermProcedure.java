...
public class SetExp10BossPermProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (entity instanceof Player _player && !_player.level.isClientSide())
			...
			}.getEntity()).getDisplayName().getString() + " was Set to " + BoolArgumentType.getBool(arguments, "set"))), false);
		{
			...
			(new Object() {
				...
				capability.Exp10TransfurAllowed = _setval;
