...
//        event.addListener(new TransfurVariantDietManager());
    ...
    public static void onDatapackSync(OnDatapackSyncEvent event) {
        //Todo: Add Other Datapack stuff handled here instead of direct packets on server join and shit.
//        SyncTransfurVariantDietsPacket packet = new SyncTransfurVariantDietsPacket(TransfurVariantDietManager.getAllDietsMap());
//
