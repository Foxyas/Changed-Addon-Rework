...
public class ChangedAddonPotions {
	...
	public static final RegistryObject<Potion> LITIXCAMONIAEFFECT = REGISTRY.register("litixcamoniaeffect", () -> new Potion(new MobEffectInstance(ChangedAddonMobEffects.UNTRANSFUR.get(), 2700, 0, false, true)));
