...
public class ChangedAddonModGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> CHANGED_ADDON_CREATURE_DIETS = GameRules.register("changedAddonCreatureDiets", GameRules.Category.PLAYER, GameRules.BooleanValue.create(false));
}
