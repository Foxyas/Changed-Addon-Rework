...
public class HUPatchouliBookProvider extends PatchouliBookProvider {

    protected final String locate;

    public HUPatchouliBookProvider(PackOutput packOutput) {
        super(packOutput, ChangedAddonMod.MODID, "hu_hu");
        this.locate = "hu_hu";
    }
