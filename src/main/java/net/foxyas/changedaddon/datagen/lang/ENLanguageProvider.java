...
public class ENLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addPatchouliDescriptions("lunar_rose", "§f§lWhisper of the Lunar Bloom§r§oIn twilight’s hush, a flower concealed,§oA silent glow, its fate is sealed.§oBorn from a mirror that hides the light,§oAnd a frozen tear, both pure and bright.§oThrough hands unseen, they intertwine, §oIn crafted bond, their fates align.§oNo flame nor forge shall shape its form,§oYet under stars, it shall be born. §oSeek the unseen, let wisdom ignite,§oFor only the knowing shall glimpse its light.");
