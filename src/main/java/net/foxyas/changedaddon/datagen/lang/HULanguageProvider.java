...
public class HULanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addBlock(LUMINARA_LOG, "Luminararönk");
        addBlock(STRIPPED_LUMINARA_LOG, "Kérgezett luminararönk");
        addBlock(LUMINARA_LEAVES, "Luminaralevelek");
        ...
        addJeiDescriptions("alpha_serum_syringe", "Befecskendezve egy transzfurált játékost alfává változtat, ha alkalmazható.");
