...
public class BasicRecipeTransferInfo<C extends AbstractContainerMenu, R> implements IRecipeTransferInfo<C, R> {
	...
	@Override
	public boolean canHandle(@NotNull C container, @NotNull R recipe) {
		return true;
	}

	@Override
	public @NotNull List<Slot> getRecipeSlots(@NotNull C container, @NotNull R recipe) {
	...
	@Override
	public @NotNull List<Slot> getInventorySlots(@NotNull C container, @NotNull R recipe) {
		List<Slot> slots = new ArrayList<>();
