...
public class Experiment009StructureFeature extends Feature<NoneFeatureConfiguration> {
	public static Experiment009StructureFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Experiment009StructureFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("changed_addon:experiment_009_structure", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("changed_addon:experiment_009_structure", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Experiment009StructureFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("changed_addon", "experiment009_lab"));
		if (template == null)
			return false;
