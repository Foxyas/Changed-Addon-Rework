...
public class GrabclickguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GrabclickguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ChangedAddonModMenus.GRABCLICKGUI, id);
