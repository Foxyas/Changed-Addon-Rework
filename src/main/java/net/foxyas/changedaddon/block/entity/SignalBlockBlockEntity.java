...
public class SignalBlockBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return new TextComponent("signal_block");
	}
	...
	public Component getDisplayName() {
		return new TextComponent("Signal Block");
	}
