...
public class LatexInsulatorBlock extends Block {
    ...
    public LatexInsulatorBlock() {
        super(BlockBehaviour.Properties.of().mapColor(MapColor.CLAY).sound(SoundType.SLIME_BLOCK).strength(0.05f, 10f).speedFactor(0.5f).noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
    }
    ...
    public void attack(BlockState blockstate, Level world, BlockPos pos, Player entity) {
        ...
        LatexInsulatorEntityCollidesInTheBlockProcedure.execute(entity);
    }
