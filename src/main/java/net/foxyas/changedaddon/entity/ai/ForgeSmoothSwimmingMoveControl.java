...
public class ForgeSmoothSwimmingMoveControl extends MoveControl {
    ...
    public ForgeSmoothSwimmingMoveControl(Mob pMob,
                                          int pMaxTurnX,
                                          int pMaxTurnY,
                                          float pInWaterSpeedModifier,
                                          float pOutsideWaterSpeedModifier,
                                          boolean pApplyGravity) {
        super(pMob);
    ...
    public void tick() {
        ...
        if (this.operation == MoveControl.Operation.MOVE_TO && !this.mob.getNavigation().isDone()) {
            ...
            if (d3 < (double) 2.5000003E-7F) {
                ...
                double attributeValue = this.mob.isInWater() ? this.mob.getAttributeValue(ForgeMod.SWIM_SPEED.get()) : this.mob.getAttributeValue(Attributes.MOVEMENT_SPEED);
                float f1 = (float) (this.speedModifier * attributeValue);
