...
public abstract class AbstractAscendDiveAbilityInstance extends AbstractAbilityInstance {
    ...
    private boolean stoppedByFloorOrWall() {
        return entity.getEntity().onGround() || entity.getEntity().horizontalCollision || entity.getEntity().verticalCollision;
    }
    ...
    public boolean canUse() {
        return this.entity.getEntity().onGround();
    }
    ...
    public boolean canKeepUsing() {
        ...
        return phase != Phase.NONE && !entity.getEntity().onGround()
