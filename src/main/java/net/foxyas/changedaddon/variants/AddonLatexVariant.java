...
public class AddonLatexVariant {
    ...
    public static final RegistryObject<TransfurVariant<SnowLeopardMaleOrganicEntity>> ORGANIC_SNOW_LEOPARD_MALE = register("form_biosynth_snow_leopard/male",TransfurVariant.Builder.of(ChangedAddonModEntities.SNOW_LEOPARD_MALE_ORGANIC)
    ...
    public static final RegistryObject<TransfurVariant<SnowLeopardFemaleOrganicEntity>> ORGANIC_SNOW_LEOPARD_FEMALE = register("form_biosynth_snow_leopard/female",TransfurVariant.Builder.of(ChangedAddonModEntities.SNOW_LEOPARD_FEMALE_ORGANIC)
    ...
    public static final RegistryObject<TransfurVariant<LatexSnowFoxEntity>> ADDON_LATEX_SNOW_FOX_MALE = register("form_latex_snow_fox/male",TransfurVariant.Builder.of(ChangedAddonModEntities.LATEX_SNOW_FOX)
            .nightVision());
    public static final RegistryObject<TransfurVariant<LatexSnowFoxFemaleEntity>> ADDON_LATEX_SNOW_FOX_FEMALE = register("form_latex_snow_fox/female",TransfurVariant.Builder.of(ChangedAddonModEntities.LATEX_SNOW_FOX_FEMALE)
            .nightVision());
    ...
    public static final RegistryObject<TransfurVariant<MirrorWhiteTigerEntity>> MIRROR_WHITE_TIGER = register("form_mirror_white_tiger_female",TransfurVariant.Builder.of(ChangedAddonModEntities.MIRROR_WHITE_TIGER)
    ...
    //Experiments
    public static final RegistryObject<TransfurVariant<LatexSnowFoxEntity>> EXP1_MALE = register("form_exp1/male",TransfurVariant.Builder.of(ChangedAddonModEntities.LATEX_SNOW_FOX)
    ...
    public static final RegistryObject<TransfurVariant<LatexSnowFoxFemaleEntity>> EXP1_FEMALE = register("form_exp1/female",TransfurVariant.Builder.of(ChangedAddonModEntities.LATEX_SNOW_FOX_FEMALE)
            .nightVision().extraJumps(2).addAbility(ChangedAddonAbilitys.PSYCHIC_PULSE).addAbility(ChangedAddonAbilitys.PSYCHIC_HOLD).addAbility(ChangedAbilities.SWITCH_GENDER).transfurMode(TransfurMode.NONE));

    public static final RegistryObject<TransfurVariant<Exp2MaleEntity>> EXP2_MALE = register("form_exp2/male",TransfurVariant.Builder.of(ChangedAddonModEntities.EXP_2_MALE)
    ...
    public static final RegistryObject<TransfurVariant<Exp2FemaleEntity>> EXP2_FEMALE = register("form_exp2/female",TransfurVariant.Builder.of(ChangedAddonModEntities.EXP_2_FEMALE)
    ...
    private static <T extends ChangedEntity> RegistryObject<TransfurVariant<T>> register(String name, TransfurVariant.Builder<T> builder) {
        DeferredRegister var10000 = REGISTRY;
        Objects.requireNonNull(builder);
        return var10000.register(name, builder::build);
    }
}
