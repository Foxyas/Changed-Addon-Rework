...
public class ChangedAddonTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<HaydenFennecFoxEntity>> HAYDEN_FENNEC_FOX = register("form_hayden_fennec_fox", () -> TransfurVariant.Builder.of(ChangedAddonModEntities.HAYDEN_FENNEC_FOX).nightVision().scares(Rabbit.class));
