...
public class ChangedAddonTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<SnowLeopardFemaleOrganicEntity>> ORGANIC_SNOW_LEOPARD_FEMALE = register("form_biosynth_snow_leopard/female", () -> TransfurVariant.Builder.of(ChangedAddonEntities.SNOW_LEOPARD_FEMALE_ORGANIC).transfurMode(TransfurMode.ABSORPTION).nightVision().breatheMode(TransfurVariant.BreatheMode.NORMAL).reducedFall().jumpStrength(1.3F).addAbility(ChangedAddonAbilities.CARRY).addAbility(ChangedAddonAbilities.TURN_FERAL_SNEP).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Creeper.class)));

    public static final RegistryObject<TransfurVariant<LatexSnowFoxEntity>> ADDON_LATEX_SNOW_FOX_MALE = register("form_latex_snow_fox/male", () -> TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_SNOW_FOX).nightVision().scares(Rabbit.class));

    public static final RegistryObject<TransfurVariant<LatexSnowFoxFemaleEntity>> ADDON_LATEX_SNOW_FOX_FEMALE = register("form_latex_snow_fox/female", () -> TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_SNOW_FOX_FEMALE).nightVision().scares(Rabbit.class));

    public static final RegistryObject<TransfurVariant<DazedEntity>> DAZED_LATEX = register("form_dazed_latex", TransfurVariant.Builder.of(ChangedAddonEntities.DAZED).transfurMode(TransfurMode.ABSORPTION).addAbility(ChangedAddonAbilities.DAZED_PUDDLE).scares(List.of()).nightVision());
    ...
    public static final RegistryObject<TransfurVariant<FoxtaFoxyEntity>> FOXTA_FOXY = register("form_foxta_foxy", () -> TransfurVariant.Builder.of(ChangedAddonEntities.FOXTA_FOXY).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Rabbit.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexKitsuneMaleEntity>> LATEX_KITSUNE_MALE = register("form_latex_kitsune/male", () -> TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.LATEX_KITSUNE_MALE).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.TELEPORT).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Rabbit.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexKitsuneFemaleEntity>> LATEX_KITSUNE_FEMALE = register("form_latex_kitsune/female", () -> TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.LATEX_KITSUNE_FEMALE).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.TELEPORT).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Rabbit.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexCalicoCatEntity>> LATEX_CALICO_CAT = register("form_latex_calico_cat", () -> TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.LATEX_CALICO_CAT).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Creeper.class)).nightVision());

    public static final RegistryObject<TransfurVariant<LatexDragonSnowLeopardSharkEntity>> LATEX_DRAGON_SNEP_SHARK = register("form_latex_dragon_snow_leopard_shark", () -> TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_DRAGON_SNOW_LEOPARD_SHARK).glide().gills().nightVision().addAbility(entityType -> ChangedAddonAbilities.WING_FLAP_ABILITY.get()));

    //Partials
    public static final RegistryObject<TransfurVariant<SnowLeopardPartialEntity>> SNOW_LEOPARD_PARTIAL = register("form_latex_snow_leopard_partial", TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.SNOW_LEOPARD_PARTIAL).stepSize(0.7F).jumpStrength(1.3F).reducedFall().breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Creeper.class)).nightVision());

    //Bosses
    public static final RegistryObject<TransfurVariant<VoidFoxEntity>> VOID_FOX = register("form_void_fox", () -> TransfurVariant.Builder.of(ChangedAddonEntities.VOID_FOX).addAbility(ChangedAddonAbilities.CLAWS).jumpStrength(1.1f).nightVision().scares(List.of(Creeper.class, Rabbit.class)));

    //Advanced
    public static final RegistryObject<TransfurVariant<AvaliEntity>> AVALI = register("form_avali", TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.AVALI).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.CUSTOM_INTERACTION).glide().transfurMode(TransfurMode.NONE).scares(List.of()).nightVision());
    public static final RegistryObject<TransfurVariant<ProtogenEntity>> PROTOGEN = register("form_protogen", () -> TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.PROTOGEN).nightVision());

    //OCs
    public static final RegistryObject<TransfurVariant<WolfyEntity>> WOLFY = register("form_wolfy", TransfurVariant.Builder.of(ChangedAddonEntities.WOLFY).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).transfurMode(TransfurMode.NONE).scares(List.of()).nightVision());
    public static final RegistryObject<TransfurVariant<ReynEntity>> REYN = register("form_reyn", TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.REYN).stepSize(0.7F).jumpStrength(1.0f).reducedFall().breatheMode(TransfurVariant.BreatheMode.NORMAL).scares(List.of()));
    public static final RegistryObject<TransfurVariant<LynxEntity>> LYNX = register("form_lynx", TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.LYNX).stepSize(0.7F).jumpStrength(1.35f).reducedFall().addAbility(ChangedAddonAbilities.LEAP).addAbility(ChangedAddonAbilities.CLAWS).breatheMode(TransfurVariant.BreatheMode.NORMAL).scares(List.of(Creeper.class)));
    public static final RegistryObject<TransfurVariant<FengQIWolfEntity>> FENGQI_WOLF = register("form_fengqi_wolf", TransfurVariant.Builder.of(ChangedAddonEntities.FENGQI_WOLF).stepSize(0.7F).breatheMode(TransfurVariant.BreatheMode.NORMAL).addAbility(ChangedAddonAbilities.CLAWS).scares(List.of(Rabbit.class)).nightVision());
    ...
    public static final RegistryObject<TransfurVariant<BagelEntity>> BAGEL = register("form_bagel", () -> TransfurVariant.Builder.of(ChangedAddonEntities.BAGEL).nightVision().scares(Rabbit.class));
    public static final RegistryObject<TransfurVariant<HaydenFennecFoxEntity>> HAYDEN_FENNEC_FOX = register("form_hayden_fennec_fox", () -> TransfurVariant.Builder.of(ChangedAddonEntities.HAYDEN_FENNEC_FOX).addAbility(ChangedAddonAbilities.ADVANCED_HEARING).reducedFall().nightVision().scares(Rabbit.class));
    ...
    public static final RegistryObject<TransfurVariant<BlueLizard>> BLUE_LIZARD = register("form_blue_lizard", TransfurVariant.Builder.of(net.foxyas.changedaddon.registers.ChangedAddonEntities.BLUE_LIZARD).addAbility(ChangedAddonAbilities.DODGE).stepSize(0.7F).sound(ChangedSounds.SOUND3.getLocation()).nightVision());

    //Experiments
    public static final RegistryObject<TransfurVariant<Exp1MaleEntity>> EXP1_MALE = register("form_exp1/male", () -> TransfurVariant.Builder.of(ChangedAddonEntities.EXP_1_MALE).nightVision().extraJumps(2).addAbility(ChangedAddonAbilities.PSYCHIC_PULSE).addAbility(ChangedAddonAbilities.PSYCHIC_HOLD).addAbility(ChangedAddonAbilities.PSYCHIC_GRAB).addAbility(ChangedAbilities.SWITCH_GENDER).transfurMode(TransfurMode.NONE));
    ...
    public static final RegistryObject<TransfurVariant<Exp2MaleEntity>> EXP2_MALE = register("form_exp2/male", () -> TransfurVariant.Builder.of(ChangedAddonEntities.EXP_2_MALE).transfurMode(TransfurMode.REPLICATION).breatheMode(TransfurVariant.BreatheMode.NORMAL).reducedFall().jumpStrength(1.3F).addAbility(ChangedAbilities.SWITCH_GENDER).addAbility(ChangedAddonAbilities.DODGE).addAbility(ChangedAddonAbilities.CARRY).addAbility(ChangedAddonAbilities.CLAWS).addAbility(ChangedAddonAbilities.UNFUSE).scares(List.of(Creeper.class)).nightVision());

    public static final RegistryObject<TransfurVariant<Exp2FemaleEntity>> EXP2_FEMALE = register("form_exp2/female", () -> TransfurVariant.Builder.of(ChangedAddonEntities.EXP_2_FEMALE).transfurMode(TransfurMode.ABSORPTION).breatheMode(TransfurVariant.BreatheMode.NORMAL).reducedFall().jumpStrength(1.3F).addAbility(ChangedAbilities.SWITCH_GENDER).addAbility(ChangedAddonAbilities.DODGE).addAbility(ChangedAddonAbilities.CARRY).addAbility(ChangedAddonAbilities.CLAWS).addAbility(ChangedAddonAbilities.UNFUSE).scares(List.of(Creeper.class)).nightVision());
