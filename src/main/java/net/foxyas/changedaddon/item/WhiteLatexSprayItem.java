...
public class WhiteLatexSprayItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		WhiteLatexSprayRightClickProcedure.execute(context.level(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.level().getBlockState(context.getClickedPos()), context.getPlayer(),
