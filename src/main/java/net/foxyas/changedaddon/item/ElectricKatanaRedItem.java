...
public class ElectricKatanaRedItem extends SwordItem implements SpecializedItemRendering {
	public ElectricKatanaRedItem() {
		super(new Tier() {
			...
			public Ingredient getRepairIngredient() {
				return CompoundIngredient.of(Ingredient.of(ItemTags.create(ResourceLocation.parse("changed_addon:tsc_katana_repair"))), Ingredient.of(new ItemStack(ChangedAddonModItems.ELECTRIC_KATANA_RED.get())));
			}
	...
	private static final ModelResourceLocation GUI_MODEL =
			new ModelResourceLocation(ResourceLocation.parse("changed_addon","electric_katana_red_item_full"), "inventory");
	private static final ModelResourceLocation HANDLE_MODEL =
			new ModelResourceLocation(ResourceLocation.parse("changed_addon","electric_katana_red_3d"), "inventory");
	private static final ModelResourceLocation EMISSIVE_MODEL =
			new ModelResourceLocation(ResourceLocation.parse("changed_addon","electric_katana_red_laser"), "inventory");
