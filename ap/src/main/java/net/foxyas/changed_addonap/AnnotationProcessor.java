package net.foxyas.changed_addonap;
...
@SupportedAnnotationTypes(
        "net.foxyas.changedaddon.extension.RequiredMods"
)
public class AnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            JavaFileObject fileObject = filer.createSourceFile("net.foxyas.changedaddon.extension.MixinDependencies");
            try (Writer writer = fileObject.openWriter()) {
                writer.write("package net.foxyas.changedaddon.extension;\n");
